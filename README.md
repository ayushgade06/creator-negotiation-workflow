...
5. **Generate draft reply** — LLM-generated for most actions; hardcoded for `HUMAN_REVIEW` & `SHIPPING_QUERY`.
...
**Scenario 2 — Creator negotiating compensation:**  
Message: `"I'd be interested, but I usually charge $300 for a TikTok video."`  
Expected: `stage: NEGOTIATING`, `action: HUMAN_REVIEW`, `requiresHumanApproval: true` (fee = 3× budget)

**Scenario 3 — Creator requesting more information:**  
